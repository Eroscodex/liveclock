  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      ...
      <div className="space-x-4">
        <button onClick={startClock} disabled={isRunning} className={`px-4 py-2 rounded ${isRunning ? "bg-gray-600" : "bg-green-500 hover:bg-green-700"}`}>Start</button>
        <button onClick={stopClock} disabled={!isRunning} className={`px-4 py-2 rounded ${!isRunning ? "bg-gray-600" : "bg-red-500 hover:bg-red-700"}`}>Stop</button>
